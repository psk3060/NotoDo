...
from sqlalchemy import String, DateTime, text, ForeignKey, Text, JSON, func
...
class TodoBase(Base):
    ...
    trashDate : Mapped[Optional[datetime]] = mapped_column("trash_date")
...
class TodoCommentBase(Base):
    ...
    id : Mapped[int] = mapped_column('id', primary_key=True)
    commentId : Mapped[str] = mapped_column("comment_id", String(30), unique=True)
