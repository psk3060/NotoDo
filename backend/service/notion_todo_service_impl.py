...
from utils.notion_util import get_created_time, get_date, get_select, get_select_name, get_status, get_status_name, get_text
        ...
        for source in notion_state.data_sources:
            ...
            for page in pages:
                ...
                todo = Todo(
                    ...
                    registDate = get_created_time(page),
